...
for x in range(10):
    ...
    nmf_with_update(data_folder / "wap.mat.csv", 5, 1, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 10, 1, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 20, 1, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 50, 1, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 5, 5, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 10, 5, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 20, 5, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 50, 5, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 5, 10, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 10, 10, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 20, 10, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 50, 10, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 5, 20, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 10, 20, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 20, 20, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 50, 20, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 5, 30, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 10, 30, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 20, 30, 300, 1e-4)
...
for x in range(10):
    ...
    # nmf_with_update(file_path, n_topics, n_labeled, max_iter, tol)
    nmf_with_update(data_folder / "wap.mat.csv", 50, 30, 300, 1e-4)
